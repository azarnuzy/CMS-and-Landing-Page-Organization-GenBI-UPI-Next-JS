...
const AwardeeCard = ({
  ...
  return (
    ...
    >
      ...
      <div className='flex gap-2 items-center absolute left-5 top-1/2 sm:-translate-y-2 transition-all transform sm:-translate-x-52 translate-x-0 translate-y-16  z-[2] group-hover:translate-x-0 group-hover:translate-y-16 duration-500'>
        <Link
          href={instagram}
          className='bg-primary-main text-neutral-100 p-3 rounded-full'
        >
          <Instagram size={24} />
        </Link>
        <Link
