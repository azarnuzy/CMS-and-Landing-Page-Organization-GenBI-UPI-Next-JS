  ...
  return (
    <div className='min-h-[50vh] relative'>
      <Image
        ...
        className='absolute top-0 -left-0 object-cover sm:object-right-bottom w-full h-full z-0'
        sizes='100vw'
      />
      <BaseLayout>
        <div className=' grid grid-cols-5 gap-4 pt-10 '>
          <div className='flex flex-col gap-4 relative z-[1] md:col-span-3 col-span-4 justify-center'>
            ...
            <div className='pl-4 text-neutral-100 text-xl sm:max-w-[400px] md:max-w-2xl border-l border-neutral-100'>
              <p>
